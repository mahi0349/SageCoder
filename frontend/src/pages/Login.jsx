...
const GithubIcon = ({ className }) => (
  <svg className={className} fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="bg-gray-900/50 backdrop-blur-xl py-8 px-4 shadow-2xl sm:rounded-2xl sm:px-10 border border-gray-800">
          <div className="space-y-6">
            ...
            <div className="mt-8">
              ...
              >
                <GithubIcon className="w-5 h-5 mr-3 group-hover:scale-110 transition-transform" />
